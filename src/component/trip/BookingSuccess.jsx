...
const BookingSuccess = () => {
  ...
  const generateSimplePDF = () => {
    ...
    pdf.setFontSize(16);
    pdf.text(booking.payment_status || "PAID", pageWidth - margin, 20, {
      align: "right",
    });
    ...
    pdf.setTextColor(0, 0, 0);
    pdf.text(booking.trip.destination, pageWidth - margin, yPosition, {
      align: "right",
    });
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-8 px-4 font-mono">
      <div className="max-w-2xl mx-auto">
        ...
        <div
          id="ticket-to-print"
          className="bg-white rounded-lg shadow-lg overflow-hidden mb-6 border border-gray-200"
        >
          {/* Ticket Header */}
