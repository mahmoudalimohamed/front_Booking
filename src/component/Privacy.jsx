      ...
      <div className="max-w-3xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
        <div className="px-6 py-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            <p className="mb-4">
              This privacy policy describes how We collects, protects, and uses
              your personal identification information on BUS-BOOKING.com and
              any of its products or services (collectively referred to as the
              "Site" or "Services"). It also describes the choices available to
            ...
            <h2 className="text-xl font-semibold text-[#A62C2C] mt-6 mb-3">
            ...
            <p className="mb-4">
              ...
              revealing any information by which you can be identified as a
              specific, identifiable individual. However, if you wish to use
              some features of the website, you will be asked to provide certain
              ...
              when you create an account, make a purchase, or fill out any
              online forms on the website. When required, this information may
              include your email address, name, phone number, address, or other
              Personal Information. You can choose not to provide us with your
              Personal Information, but then you may not be able to take
              advantage of some features of the website. Users who are uncertain
            ...
            <p className="mb-4">
              You can access, add to, update, and delete certain Personal
              ...
              from your account. We will retain your Personal Information for as
              long as necessary to comply with our legal obligations, resolve
            ...
            <p className="mb-4">
              ...
              process transactions; send newsletters; send notification emails
              such as password reminders, updates, etc.; run and operate our
              website and Services. The information collected automatically is
              ...
              identify any particular user of the system. We may process
              Personal Information related to you if one of the following
              applies:
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              (2) Provision of information is necessary for the performance of
            ...
            <p className="mb-4">
              (4) Processing is related to a task that is carried out in the
              public interest or in the exercise of official authority vested in
              us;
            </p>
            <p className="mb-4">
              (5) Processing is necessary for the purposes of the legitimate
            ...
            <ul className="list-disc list-inside mb-4 ml-4">
              ...
              <li className="mb-2">
                ...
                processing of your information, in which case, we will not
            ...
            <p className="mb-4">
              ...
              technologies as described above, we may also permit certain
              third-party companies to help us tailor advertising that we think
              may be of interest to users and to collect and use other data
              about user activities on the website. These companies may deliver
            ...
            <p className="mb-4">
              ...
              Information, you acknowledge that (1) there are security and
              privacy limitations of the Internet which are beyond our control;
              (2) the security, integrity, and privacy of any and all
              information and data exchanged between you and our website cannot
              be guaranteed; and (3) any such information and data may be viewed
